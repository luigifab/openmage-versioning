You must update your index.php with the following code.
Be careful if you are not using /admin/ for your backend.
...
These files will be automatically created when you will save the module configuration in the backend:
